          ...
          <div class="menu-container isotope-container row gy-4">
            ...
            <div class="col-lg-6 isotope-item filter-starters">
              <div class="menu-item d-flex align-items-center gap-4">
                ...
                <div class="menu-content">
                  ...
                  <div class="price">150.00 Pesos</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 isotope-item filter-main">
              <div class="d-flex menu-item align-items-center gap-4">
                ...
                <div class="menu-content">
                  <h5>Sisig <span class="menu-tag">Chef's Choice</span></h5>
            ...
            <div class="col-lg-6 isotope-item filter-dessert">
              <div class="d-flex menu-item align-items-center gap-4">
                ...
                <div class="menu-content">
                  <h5>Mango Float <span class="menu-tag">Gluten Free</span></h5>
            ...
            <div class="col-lg-6 isotope-item filter-dessert">
              <div class="d-flex menu-item align-items-center gap-4">
                ...
                <div class="menu-content">
                  <h5>Fruit Salad <span class="menu-tag">Classic</span></h5>
            ...
            <div class="col-lg-6 isotope-item filter-drinks">
              <div class="d-flex menu-item align-items-center gap-4">
                ...
                <div class="menu-content">
                  <h5>Pineapple Juice <span class="menu-tag">Alcoholic</span></h5>
            
                  <div class="price">30.00 Pesos</div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="menu-item special-item">
                  ...
                  <div class="menu-item-content">
                    ...
                    <div class="menu-item-price">50.00 Pesos</div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
